...
export default function Footer() {
  ...
  const Stoast = useToast({
    title: `Your information has been safely stored!`,
    status: "success",
    isClosable: true,
    position: "top",
  });
        ...
        >
          <Stack spacing={6}>
            ...
            >
              {/* <SiGoogleearth
                size={30}
                style={{ marginLeft: "65px", marginBottom: "-26px" }}
              />{" "} */}
              Ecotourism
            </Text>
            <Text style={{ textAlign: "left", fontSize: "16px" }}>
              Welcome to our travel website, your ultimate destination for all
              your travel needs! Whether you're a seasoned explorer or a
              first-time traveler, we are here to inspire and assist you on your
              journey. Our platform offers a wide range of services, including
              flight bookings, hotel accommodations, vacation packages, car
              rentals, and much more. With our user-friendly interface and
              comprehensive search options, finding the perfect travel options
              has never been easier. So, get ready to embark on unforg
            </Text>
